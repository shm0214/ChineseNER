...
def read_seg_instance(input_file,
                      word_alphabet,
                      biword_alphabet,
                      char_alphabet,
                      label_alphabet,
    ...
    for idx in range(len(in_lines)):
        ...
        if len(line) > 2:
            ...
            if idx < len(in_lines) - 1 and len(in_lines[idx + 1]) > 2:
                biword = word + in_lines[idx +
                                         1].strip().split()[0].decode('utf-8')
            else:
                biword = word + NULLKEY
...
def read_instance_with_gaz(input_file,
                           gaz,
                           word_alphabet,
                           biword_alphabet,
                           char_alphabet,
...
def read_instance_with_gaz_in_sentence(input_file,
                                       gaz,
                                       word_alphabet,
                                       biword_alphabet,
                                       char_alphabet,
    ...
    for idx in range(len(in_lines)):
        ...
        instence_Ids.append(
            [word_Ids, biword_Ids, char_Ids, gaz_Ids, label_Id])
    return instence_texts, instence_Ids
...
def read_instance_with_gaz_softLexicon(num_layer,
                           input_file,
                           gaz,
                           word_alphabet,
                           biword_alphabet,
